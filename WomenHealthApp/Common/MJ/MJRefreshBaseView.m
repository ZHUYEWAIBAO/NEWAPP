...
//    UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:kSrcName(@"arrow.png")]];
    UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageWithContentFileName:@"arrow.png"]];
...
- (void)setFrame:(CGRect)frame
{
    ...
    _arrowImage.center = CGPointMake(arrowX+45, frame.size.height * 0.5);
    _arrowImage.frame = CGRectMake(_arrowImage.frame.origin.x, _arrowImage.frame.origin.y, 22, 22);
